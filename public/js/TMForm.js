/* the code below is for PHP execution
 */
(function($){
		...
		function TMForm(){
			...
			function formSubmit(){
				...
				if(!$('label.'+opt.invalidClass+',label.'+opt.emptyClass,form).length){					
					$.get('/contactus/mail', data, function(e) {
...
/*
 ...
 Written By Vivin Paliath (http://vivin.net) modified by Hyeonsu Kang (https://cseweb.ucsd.edu/~hyk149)
 License: BSD License
 */
...
$(window).load(function(){
      $('#form').TMForm({
          ownerEmail:'a1235dlw2kd225dswd@gmail.com' 
      })
    })
